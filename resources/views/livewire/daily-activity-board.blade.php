            ...
            <form wire:submit="saveHandover" class="space-y-4">
                ...
                <div class="flex items-center justify-end gap-2 pt-2 border-t border-gray-100">
                    ...
                    <button type="submit"
                        ...
                        <svg wire:loading wire:target="submitHandover" class="animate-spin h-3.5 w-3.5 text-white" fill="none" viewBox="0 0 24 24">
                            <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                            <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                        </svg>
        ...
        <div class="bg-white rounded-2xl shadow-2xl max-w-xl w-full p-6 text-left border border-emerald-100 animate-scale-in"
            ...
            <form wire:submit="confirmAcceptHandover" class="space-y-4">
                ...
                <div class="flex items-center justify-end gap-2 pt-2 border-t border-gray-100">
                    ...
                    <button type="submit"
                            wire:loading.attr="disabled"
                            wire:target="acceptHandover"
                            class="px-4 py-2 text-xs font-bold bg-[#1B6B3A] text-white rounded-lg hover:bg-[#15532D] transition-colors shadow-sm flex items-center gap-1.5">
                        <svg wire:loading wire:target="acceptHandover" class="animate-spin h-3.5 w-3.5 text-white" fill="none" viewBox="0 0 24 24">
                            <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                            <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                        </svg>
