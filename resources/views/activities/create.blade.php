            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <select id="priority" name="priority"
                            class="block w-full rounded-lg border-gray-300 shadow-sm text-sm focus:ring-[#1B6B3A] focus:border-[#1B6B3A]">
                        <option value="low" {{ old('priority') === 'low' ? 'selected' : '' }}>P4 — Low Priority</option>
                        <option value="medium" {{ old('priority', 'medium') === 'medium' ? 'selected' : '' }}>P3 — Medium Priority (Standard)</option>
                        <option value="high" {{ old('priority') === 'high' ? 'selected' : '' }}>P2 — High Priority</option>
                        <option value="critical" {{ old('priority') === 'critical' ? 'selected' : '' }}>P1 — Critical (Urgent SRE Check)</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <input type="text" id="sla_time" name="sla_time" value="{{ old('sla_time') }}"
