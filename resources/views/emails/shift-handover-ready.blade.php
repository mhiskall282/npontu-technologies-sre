...
<head>
    ...
    <title>Shift Handover Ready</title>
</head>
                                ...
                                <tr>
                                    <td>
                                        <div style="font-size: 11px; font-weight: 800; color: #F5C518; letter-spacing: 2px; text-transform: uppercase; margin-bottom: 4px;">
                                            SRE PROTOCOL &bull; DUAL-ACCEPTANCE HANDOVER
                                        </div>
                                        <h1 style="margin: 0; font-size: 20px; font-weight: 700; color: #ffffff;">
                                            🔄 Shift Handover Awaiting Sign-Off
                                        </h1>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td style="padding: 30px;">
                            ...
                            <p style="font-size: 14px; line-height: 1.6; color: #4b5563; margin-top: 0; margin-bottom: 20px;">
                                <strong>{{ $outgoingLead?->name ?? 'Outgoing Lead' }}</strong> has prepared and finalized the operational shift report for the <strong>{{ strtoupper($handover->shift_type ?? 'day') }}</strong> shift on <strong>{{ $handover->shift_date?->format('Y-m-d') }}</strong>.
                            </p>

                            {{-- Handover Notes --}}
                            <div style="background-color: #f9fafb; border-left: 4px solid #F5C518; border-radius: 8px; padding: 18px 20px; margin-bottom: 24px;">
                                <div style="font-size: 12px; font-weight: 700; color: #92400e; margin-bottom: 6px; text-transform: uppercase;">
                                    Outgoing Shift Briefing Notes
                                </div>
                                <div style="font-size: 14px; color: #1f2937; line-height: 1.6;">
                                    {{ $handover->notes ?: 'All scheduled checkoffs verified. Handover ready for incoming sign-off.' }}
                                </div>
                            </div>
