    ...
    <div class="bg-[#050B07] border-b border-white/5 py-1.5 px-4 text-center text-[11px] text-gray-400 font-mono">
        <div class="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-2">
            <div class="flex items-center gap-2">
                ...
                <span>PRODUCTION NOC: ACCRA-CLUSTER-01</span>
                <span class="text-gray-600">|</span>
                <span class="text-emerald-300">ISO 27001 & SOC 2 TYPE II ALIGNED</span>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
            <div class="flex items-center gap-3">
                <a href="{{ route('landing') }}" class="flex items-center gap-2.5 group">
                    ...
                    <div>
                        <span class="font-extrabold text-sm tracking-tight text-white block leading-none">Support Tracker</span>
            ...
            <nav class="hidden md:flex items-center gap-6 text-xs font-semibold text-gray-300">
                ...
                <a href="{{ route('landing') }}#the-handshake" class="hover:text-[#F5C518] transition-colors">Handover Engine</a>
                <a href="{{ route('health') }}" class="hover:text-[#F5C518] transition-colors">Telemetry HUD</a>
                <a href="{{ route('policy.privacy') }}" class="text-[#F5C518]">Legal & SRE Policies</a>
            </nav>
            ...
            <div class="flex items-center gap-3">
                @auth
                    <a href="{{ route('activities.daily') }}"
                       class="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-xl bg-[#1B6B3A] hover:bg-[#2A8F52] text-white font-bold text-xs shadow-md transition-colors">
                        <span>Daily Cockpit</span>
                        <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"/></svg>
                    </a>
                @else
                    <a href="{{ route('login') }}"
                       class="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-xl bg-[#F5C518] hover:bg-amber-400 text-gray-950 font-bold text-xs shadow-md transition-colors">
